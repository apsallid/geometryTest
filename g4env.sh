...
source /afs/cern.ch/sw/lcg/contrib/gcc/4.8/${ARCH}/setup.sh 
...
cd $G4BASE/10.2.p02/${ARCH}/share/Geant4-10.2.2/geant4make/
#cd $G4BASE/10.2/${ARCH}/share/Geant4-10.2.0/geant4make/
source geant4make.sh
cd - &> /dev/null
#for boost latest version
export BOOSTSYS=/cvmfs/cms.cern.ch/slc6_amd64_gcc472/external/boost/1.47.0-cms
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$XERCESCROOT/lib:$HEPMC_DIR/lib:$USERBASE/userlib/lib:/afs/cern.ch/work/a/apsallid/CMS/Geant4/PFCal/PFCalEE/userlib/lib:$USERBASE/analysis/lib:$FASTJET_INSTALL/lib:$BOOSTSYS/lib:$QTHOME/lib
