...
void RunAction::EndWorker(const G4Run* run)
{
  ...
  G4cout << "Number and type of particles created in region \"World\" :" << G4endl;
  ...
  std::map<const G4ParticleDefinition*, int>&
    particlesCreatedInTarget1 = fpTrackingAction->GetNParticlesCreatedInTarget1();
  
  G4cout << "Number and type of particles created in region \"Target1\" :" << G4endl;
  
  PrintNParticles(particlesCreatedInTarget1);

  std::map<const G4ParticleDefinition*, int>&
    particlesCreatedInTarget2 = fpTrackingAction->GetNParticlesCreatedInTarget2();
  
  G4cout << "Number and type of particles created in region \"Target2\" :" << G4endl;
  
  PrintNParticles(particlesCreatedInTarget2);

  std::map<const G4ParticleDefinition*, int>&
    particlesCreatedInTarget3 = fpTrackingAction->GetNParticlesCreatedInTarget3();
  
  G4cout << "Number and type of particles created in region \"Target3\" :" << G4endl;
  
  PrintNParticles(particlesCreatedInTarget3);
...
void RunAction::CreateHistogram()
{
	...
	G4String fileName = "geometryTest";
	analysisManager->OpenFile(fileName);

	// Creating ntuple

	analysisManager->CreateNtuple("geometryTest", "physics");
